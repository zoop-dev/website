...
var canvas = document.getElementById('play-gl');
resizeCanvas();
...
canvas.addEventListener('mousemove', function (e) {
    ...
    var posX = scaleByPixelRatio(e.offsetX);
    var posY = scaleByPixelRatio(e.offsetY);
    if (!pointer.down) { updatePointerDownData(pointer, -1, posX, posY); return; }
...
window.fluidSplats = function(n){ try { multipleSplats(n || 12); } catch(e){} };
